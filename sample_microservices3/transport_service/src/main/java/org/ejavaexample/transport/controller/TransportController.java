package org.ejavaexample.transport.controller;

import org.ejavaexample.transport.entity.Transport;
import org.ejavaexample.transport.entity.TransportStep;
import org.ejavaexample.transport.payload.response.DataResponse;
import org.ejavaexample.transport.payload.response.MessageResponse;
...
import org.ejavaexample.transport.service.TransportServiceImpl;
import org.ejavaexample.transport.service.TransportStepServiceImpl;
...
public class TransportController {
    ...
    public ResponseEntity<?> planPath(@RequestBody Map<String, String> params){
        ...
        try{
            ...
            Map<String,Object>maniInfo=restTemplate.getForObject("http://MANIFEST-SERVICE:8003/api/mani/manifest/get-begin-and-end-address/"+manifestId,Map.class);
            if(!maniInfo.isEmpty()){
                ...
                restTemplate.getForObject("http://MANIFEST-SERVICE:8003/api/mani/manifest/update-begin-and-end-id/"+manifestId+"&&"+beginId+"&&"+endId,Integer.class);
